    ...
    <section id="cta" className="py-24 relative overflow-hidden font-jetbr">
      <div className="container mx-auto px-4 md:px-6">
        <div className="glass rounded-2xl p-8 md:p-12 relative z-10 overflow-hidden">
          {/* Background effects */}
          <div className="absolute -top-24 -right-24 w-64 h-64 bg-primarysecond/60 rounded-full filter blur-[80px] opacity-50"></div>
          <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-red-600/30 rounded-full filter blur-[80px] opacity-50"></div>

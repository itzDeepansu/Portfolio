    ...
    <div className="min-h-screen text-white font-jetbr">
      ...
      <nav className="glass fixed top-0 w-full z-50 px-6 py-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <Link
            href="https://e-commerce-project-db.vercel.app"
            target="_blank"
            className="button-outline hidden md:block hover:bg-blue-400 hover:text-white"
          >
            Try Demo
          </Link>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 max-w-xl mx-auto">
              ShopNi comes packed with all the essential features needed for a
            ...
            {[
              {
                ...
                description:
                  "Secure login & sign-up with JWT authentication, password hashing, and persistent sessions.",
              },
              {
                icon: <Package size={24} />,
                title: "Inventory Management",
                description:
                  "Efficient stock tracking system with real-time updates and automated notifications.",
              },
              {
                icon: <ShoppingCart size={24} />,
                title: "Cart Management",
                description:
                  "Smooth shopping experience with persistent cart storage and quantity management.",
              },
              {
                icon: <CreditCard size={24} />,
                title: "Payment Gateway",
                description:
                  "Seamless checkout process powered by Stripe API with support for various payment methods.",
              },
              {
                icon: <Database size={24} />,
                title: "State Management",
                description:
                  "Optimized performance with Redux for global state management and data persistence.",
              },
              {
                icon: <Layout size={24} />,
                title: "Responsive Design",
                description:
                  "Beautiful, consistent user interface that works flawlessly across all device sizes.",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
          ...
          <div className="glass-card p-12 relative">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-6">
              {[
                ...
                >
                  <div
                    className="h-16 w-16 rounded-full glass flex items-center justify-center mb-3 animate-float"
          ...
          <div className="glass-card p-10 text-center">
            <div className="max-w-xl mx-auto flex flex-col items-center">
              ...
              <p className="text-gray-300 mb-8">
                Experience the full capabilities of ShopNi through our live demo
                or explore the code to see how it&apos;s built.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                ...
                <Link
                  href="https://github.com/itzDeepansu/ECommerce-Project-DB"
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      <section id="contact" className="py-20 px-6 h-[80dvh]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 max-w-xl mx-auto">
              Have questions or interested in contributing? Reach out to our
              team.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <motion.a
              href="https://github.com/itzDeepansu"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-shopni-purple/20 transition-colors">
                <GitFork
                  className="text-white group-hover:text-shopni-purple transition-colors"
                  size={20}
                />
              </div>
            ...
            <motion.a
              href="https://www.linkedin.com/in/deepansu/"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.05 }}
              className="glass-card p-6 flex items-center gap-4 group animate-glow min-w-[200px]"
            ...
            >
              <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-shopni-blue/20 transition-colors">
                <User
                  className="text-white group-hover:text-shopni-blue transition-colors"
                  size={20}
                />
              </div>
              <div className="text-left">

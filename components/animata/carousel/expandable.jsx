...
// No need for interfaces in plain JavaScript
...
const generateItems = () => {
  ...
  for (let i = 1; i <= 300; i++) {
    ...
    items.push({
      image: `/images/male${imageNumber}.png`,
      title: `Male ${imageNumber}`,
    });
  }
  return items;
};

export default function Expandable({ list = generateItems(), autoPlay = true, className }) {

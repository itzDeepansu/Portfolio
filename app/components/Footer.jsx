...
const Footer = ({ className }) => {
  ...
  return (
    <div className={`z-50 bg-background/80 backdrop-blur-md max-h-20 w-[calc(100dvw-5rem)] fixed bottom-0 grid grid-cols-6 text-xs items-end font-jetbr pb-1 ${className}`}>
